...
int main()
{
   ...
   do
   {
      ...
      for (intCount = 0; intCount < used1; ++intCount)
      {
         ...
         intArr2[i2Inc++] = intToCopy;
         intArr2[i2Dec--] = intToCopy;
      }
    ...
    //  DebugShowCase(testCasesDone, testCasesToDo, intArr0, used0);
      ...
      iLenChk1 = ListLengthCheck(head1, 2*used1);
      if (iLenChk1 != 0)
      {
         if (iLenChk1 == -1)
         {
